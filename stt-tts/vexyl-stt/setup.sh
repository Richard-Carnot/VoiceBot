...
echo -e "  ${CYAN}Installing PyTorch + torchaudio (CUDA)...${NC}"
pip install torch torchaudio -q
print_ok "torch + torchaudio (CUDA)"

echo -e "  ${CYAN}Installing remaining dependencies from requirements.txt...${NC}"
